...
class Help(commands.Cog):
    ...
    async def ajuda(self, ctx):
        ...
        embed_link = discord.Embed(title="Help",
                                   description=f"*Já que o burrinho do {nn} não sabe os comandos tá ai uma lista:*",
                                   colour=6606329)
    ...
    @commands.has_any_role("NOBREZA")
    async def ajudamusic(self, ctx):
        nn = ctx.author.mention
        ...
        embed_music .add_field(name="Comandos:", value="__***!play ou !p***__ - Adiciona música a fila \n \n "
                                                       "__***!skip ou !s***__ - Pula a música atual \n \n"
                                                       "__***!queue ou !q***__ - Mostra a fila de reprodução atual  ",
                               inline=False)
    ...
    async def dev(self, ctx):
        ...
        await ctx.send(embed=embed_dev)
